        ...
        < >
            <div className='py-4 d-flex flex-column align-items-center' style={{ backgroundColor: "whitesmoke" }}>
                ...
                <div className='container justify-content-center'>
                    <div className='row mb-2'>
                        <div className='col rounded' style={{ height: "250px", width: "300px" }}>
                            <img src="./images/carousel_img.jpg" className='rounded' alt="" style={{ height: "100%", width: "100%" }} />
                        </div>
                        <div className='col rounded' style={{ height: "250px", width: "300px" }}>
                            <img src="./images/carousel_img3.jpg" className='rounded' alt="" style={{ height: "100%", width: "100%" }} />
                        </div>
                        <div className='col rounded' style={{ height: "250px", width: "300px" }}>
                            <img src="./images/carousel_img5.jpg" className='rounded' alt="" style={{ height: "100%", width: "100%" }} />
                        </div>
                    </div>
                    <div className='row'>
                        <div className='col rounded' style={{ height: "250px", width: "300px" }}>
                            <img src="./images/carousel_img4.jpg" className='rounded' alt="" style={{ height: "100%", width: "100%" }} />
                        </div>
                        <div className='col rounded' style={{ height: "250px", width: "300px" }}>
                            <img src="./images/carousel_img6.jpg" className='rounded' alt="" style={{ height: "100%", width: "100%" }} />
                        </div>
                        <div className='col rounded' style={{ height: "250px", width: "300px" }}>
                            <img src="./images/carousel_img7.jpg" className='rounded' alt="" style={{ height: "100%", width: "100%" }} />
                        </div>
                    </div>
                ...
                <div className='d-flex justify-content-center mb-5' style={{ gap: "100px" }}>
                    <img src="./images/about-1.jpg" alt="" style={{ width: "500px" }} />
                ...
                <div className='d-flex justify-content-center mb-5' style={{ gap: "100px" }}>
                    ...
                    <img src="./images/about-2.jpg" alt="" style={{ width: "500px" }} />
                </div>
                <div className='d-flex justify-content-center mb-5' style={{ gap: "100px" }}>
                    <img src="./images/about-3.jpg" alt="" style={{ width: "500px" }} />
                    <div className='d-flex flex-column justify-content-center ' style={{ width: "500px" }}>
                ...
                <div className='d-flex justify-content-center mb-5' style={{ gap: "100px" }}>
                    ...
                    <img src="./images/about-4.jpg" alt="" style={{ width: "500px" }} />
                </div>
            </div>
        </ >
    )
